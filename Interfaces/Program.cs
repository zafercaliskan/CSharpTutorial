...
namespace Interfaces
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //IPersonManager'da bu referans değerini tutabiliyor. Yani interfaceler onu implemente eden (new CustomerManager();) class'ın 
            //referans numarasını tutabilirler.
    ...
    class CustomerManager : IPersonManager //Bunlarda bu şablona uymak zorunda. İmzalar aynı. Kod içerikleri farklı. Buda IPersonManager.
    {
    ...
    class EmployeeManager : IPersonManager //Bunlarda bu şablona uymak zorunda. İmzalar aynı. Kod içerikleri farklı. Buda IPersonManager.
    {
        public void Add()
        {
